...
Quick command: `python3 -m unittest discover -s examples/f05_memory -p 'test_*.py'`.
...
|---|---|---|---|---|---|---|---|---|---|
| 04-01-01 | 01 | 1 | F05-01, F05-02 | T-04-02/T-04-03 | Public synthetic data and honest provenance | behavior | See task automated command in PLAN.md | Created by first example task | pending |
| 04-01-02 | 01 | 1 | F05-01, F05-02 | T-04-02/T-04-03 | Public synthetic data and honest provenance | artifact plus evidence review | See task automated command in PLAN.md | Created by owning task | pending |
| 04-02-01 | 02 | 2 | F05-03 | T-04-02/T-04-03 | Public synthetic data and honest provenance | artifact plus evidence review | See task automated command in PLAN.md | Created by owning task | pending |
| 04-02-02 | 02 | 2 | F05-03 | T-04-02/T-04-03 | Public synthetic data and honest provenance | artifact plus evidence review | See task automated command in PLAN.md | Created by owning task | pending |
...
|---|---|---|---|
| Actual Quill authorship | F05-03 | JSON syntax cannot prove a real writer/run | Inspect actual workflow receipt and returned artifact; no substitute |
