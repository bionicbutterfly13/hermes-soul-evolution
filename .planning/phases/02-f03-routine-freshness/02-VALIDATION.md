...
Quick command: `python3 -m unittest discover -s examples/f03_freshness -p 'test_*.py'`.
...
|---|---|---|---|---|---|---|---|---|---|
| 02-01-01 | 01 | 1 | F03-01, F03-02 | T-02-02/T-02-03 | Public synthetic data and honest provenance | behavior | See task automated command in PLAN.md | Created by first example task | pending |
| 02-01-02 | 01 | 1 | F03-01, F03-02 | T-02-02/T-02-03 | Public synthetic data and honest provenance | artifact plus evidence review | See task automated command in PLAN.md | Created by owning task | pending |
| 02-02-01 | 02 | 2 | F03-03 | T-02-02/T-02-03 | Public synthetic data and honest provenance | artifact plus evidence review | See task automated command in PLAN.md | Created by owning task | pending |
| 02-02-02 | 02 | 2 | F03-03 | T-02-02/T-02-03 | Public synthetic data and honest provenance | artifact plus evidence review | See task automated command in PLAN.md | Created by owning task | pending |
...
|---|---|---|---|
| Actual Quill authorship | F03-03 | JSON syntax cannot prove a real writer/run | Inspect actual workflow receipt and returned artifact; no substitute |
